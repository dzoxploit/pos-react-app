...
import {
    GET_CATEGORYGUDANG,
    GET_CATEGORYGUDANG,
    CLEAR_CURRENT_CATEGORYGUDANG,
    CATEGORYGUDANG_LOADING,
    GET_ERRORS,
    DELETE_CATEGORYGUDANG,
} from "./types";

export const getCurrentCategoryGudang = () => dispatch => {
    dispatch(setCategoryGudangLoading());
    axios
        .get("api/bahan-baku")
        .then(res =>
            dispatch({
                type: GET_CATEGORYGUDANG,
                payload: res.data
            })
        )
        .catch(err => 
...
export const getCategoryGudangByCategoryCode = category_code => dispatch => {
    dispatch(setCategoryGudangLoading());
    axios
        .get(`api/category-gudang/edit/${category_code}`)
        .then(res => 
            dispatch({
                type: GET_BAHANBAKU,
                payload: res.data
