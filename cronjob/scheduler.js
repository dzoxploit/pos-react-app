...
const device_number = "081413309326";
...
const wa_token = "masukan API Key Disini";
...
module.exports = {
  ...
  */
  async addNewScheduleNNews(email, interval) {
    let jsonObject = {
      jobs: []
    };
  ...
  */
  ...
  async startMonitoringNews(email, interval) {
    let setInterval;
...
*/
  ...
  async stopMonitoringNews(email) {
  ...
  async sendWhatsappPhoneNumber(phone_number){
